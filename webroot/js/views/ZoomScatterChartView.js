                ...
                .on("mouseup.zoomRect", function () {
                    ...
                    if(chartOptions['doBucketize'] != true) {
                        ...
                        chartSVG.selectAll("circle").attr("transform", function (d) {
                            var xTranslate = chartModel.xScale(getValueByJsonPath(d,chartConfig.xField)) + maxCircleRadius,
                                yTranslate = chartModel.yScale(getValueByJsonPath(d,chartConfig.yField));
    ...
    function getChartZoomFn(chartView, chartConfig) {
        return function () {
            ...
            chartView.svg.selectAll("circle").attr("transform", function (d) {
                var xTranslate = chartModel.xScale(getValueByJsonPath(d,chartConfig.xField)) + chartConfig.maxCircleRadius,
                    yTranslate = chartModel.yScale(getValueByJsonPath(d,chartConfig.yField));
                //Position the non x/y nodes at axis start
                if(!$.isNumeric(xTranslate))
